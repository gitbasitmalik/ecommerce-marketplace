        ...
        <div className="container mx-auto px-4">
          ...
          <div className="hidden md:flex items-center justify-between py-3">
            <div className="flex items-center space-x-6">
              ...
              <button
                onClick={() => onNavigate("/products?featured=hot")}
                className="text-sm text-red-500 hover:text-red-600"
              >
                Hot offers
              </button>
              <button onClick={() => onNavigate("/products?category=gifts")} className="text-sm hover:text-blue-500">
                Gift boxes
              </button>
              <button onClick={() => onNavigate("/projects")} className="text-sm hover:text-blue-500">
                Projects
              </button>
          ...
          <div className="md:hidden py-2">
            <div className="flex items-center justify-between text-sm">
              <button onClick={() => onNavigate("/products?featured=hot")} className="text-red-500">
                Hot offers
              </button>
              <button onClick={() => onNavigate("/products?category=gifts")} className="text-gray-600">
                Gift boxes
              </button>
              <button onClick={() => onNavigate("/projects")} className="text-gray-600">
                Projects
              </button>
