...
export function ProductCard({ product, viewMode = "grid", onNavigate }: ProductCardProps) {
  ...
  if (viewMode === "list") {
    return (
      <Card className="p-3 lg:p-4 hover:shadow-md transition-shadow cursor-pointer" onClick={handleCardClick}>
  ...
  return (
    <Card className="p-3 lg:p-4 hover:shadow-md transition-shadow group cursor-pointer" onClick={handleCardClick}>
